...
import 'package:cgheven/model/download_item_model.dart';
...
class _DownloadScreenState extends State<DownloadScreen> {
  ...
  List<DownloadItem> get activeDownloads =>
      downloads.where((item) => item.status != "Completed").toList();
          ...
          child: Row(
            children: [
              ...
              TextButton.icon(
                onPressed: () {
                  setState(() {
                    downloads.removeWhere((item) => item.status == "Completed");
                  });
                },
                icon: const Icon(
                  Icons.delete,
  ...
  List<Widget> _buildActionButtons(DownloadItem item) {
    ...
    if (item.status == "Download") {
      buttons.add(
        _buildActionButton('Pause', Icons.pause, const Color(0xFFFBBF12)),
      );
